...
<head>
    ...
    <title>shakedown - panel użytkownika</title>
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                {{--<li>--}}
                    ...
                    {{--</a>--}}
                {{--</li>--}}
                <li class="item {{ active_route('user.index')}}">
                    <a href="{{route('user.index')}}">
                        <i class="pe-7s-user"></i>
                        <p>Mój profil</p>
                    </a>
                </li>
                <li class="item {{active_route('article.index')}}">
                    <a href="{{route('article.index')}}">
                        <i class="pe-7s-news-paper"></i>
                        <p>Moje artykuły</p>
                    </a>
                </li>
                <li class="item {{active_route('comments')}}">
